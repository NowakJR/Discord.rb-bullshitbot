...
#a = ["NOWAK","KONDON","GOŁĄBEK","KRZYCHU","RYSZARD","OSKAR","MANIEK","ROGI","MARCO","GRUBY","KOS","PASIOR","BORTNIAK","SWIERZY","SWIERZY","SWIERZY","SWIERZY","SWIERZY","SWIERZY","SWIERZY","SWIERZY","SWIERZY","SWIERZY","SWIERZY","SWIERZY""SWIERZY","SWIERZY","SWIERZY","SWIERZY","SWIERZY","SWIERZY","SWIERZY","SWIERZY"]
#b = a.sample
...
a = ["NOWAK","KONDON","GOŁĄBEK","KRZYCHU","RYSZARD","OSKAR","MANIEK","ROGI","MARCO","GRUBY","KOS","PASIOR","BORTNIAK","SWIERZY","SWIERZY","SWIERZY"]


bot.command :gowno do |msg|
  msg.respond """
...
⣿⡌⢿⣿⣿⣿⣿⣧⡙⢿⢣⣿⣿⣿⡏⣼⣧⣌⠻⢿⢣⣿⣿⣿⣿⢇⣿⣿⣿⣿
"""
bot.command :pepehands do |msg|
  msg.respond pepehands
  end
bot.command :monkas do |msg|
  msg.respond monkas
end
bot.command :dupa do |msg|
  msg.respond dupa
end
bot.command :obama do |msg|
  msg.respond obama
end
bot.command :amongus do |msg|
  msg.respond amongus
end
